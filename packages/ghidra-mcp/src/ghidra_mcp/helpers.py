...
from re_mcp.helpers import parse_address as _parse_address_numeric
...
# ---------------------------------------------------------------------------
# Ghidra-specific address parsing (extends shared parse_address with symbols)
# ---------------------------------------------------------------------------
...
def parse_address(addr: str | int) -> int:
    ...
    Symbol name resolution is handled separately via Ghidra's symbol table.
    """
    return _parse_address_numeric(addr)
...
def resolve_address_value(addr: str | int) -> int:
    ...
    try:
        return _parse_address_numeric(addr_str)
    except ValueError:
        pass
