...
from ghidra_mcp import find_ghidra_dir
from ghidra_mcp.exceptions import GhidraError
from ghidra_mcp.transforms import MANAGEMENT_TOOLS, PINNED_TOOLS
...
class GhidraBackend:
    ...
    def register_prompts(mcp: FastMCP) -> None:
        from ghidra_mcp.prompts import register_all  # noqa: PLC0415
